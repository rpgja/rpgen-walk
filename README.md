...
- 規約の引用元
  - [RPGEN掲載ページ](https://rpgen.org/dq/sprites/1958/)
  - [Pixivプロフィール](https://www.pixiv.net/users/356391)

> [!TIP]
> - 目・腕・足の位置をトレースして別キャラを描く程度であれば、改変・再配布に当たらないと思われますが、
> あくまでWebアプリ提供者側の個人的な解釈です。
